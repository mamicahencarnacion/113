...
<title>Encarino Country and Golf-CGallery </title>
  ...
  <body><div id="title" class="component">
		...
		<div id="nap39" class="component tabBar tabbable tabs-left">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a id="nap39i2" href="golfGallery.jsp" data-toggle="tab">Golf Course</a></li>
	...
	<div id="imageThumbnails">
		<marquee behavior="scroll" direction="down" height="550px"
				...
				<br><br><br>
		<table> <tr> <td><img src="golf1.jpg"></img></td> <br>
		<table> <tr> <td><img src="golf2.jpg"></img></td><br>
		<table> <tr> <td><img src="golf3.jpg"></img></td> <br></tr> </table> 
