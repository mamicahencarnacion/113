...
<title>Encarino Golf and Country Club</title>
<link rel="stylesheet" href="bootstrap.min.css">
	...
	<body>
		...
		<span id="memlog" class="component" style="white-space:normal;"><b>Membership Login</b></span>
		
		<form action="welcome.jsp" method="post">
			<input name="email" id="emailTxT" type="email" placeholder="Email Address" class="component" required  >
			<input name="pw" id="passswordTxT" type="password" placeholder="Password" class="component" required >
			<span id="email" class="component">Email:</span>
			<span id="password" class="component">Password:</span>
			<button id="loginBtn" type="submit" class="component btn" onclick="validate()">Login</button>
			<span id="containerbox" class="component">
				<label for="cbox" class="checkbox">
		...
		<script>
			function validate(){
				...
				var pw = document.getElementById("passswordTxT").value;
				
				if(pw.length < 8 || pw.length > 30 || email.length == 0){
					alert("Invalid email or password. Please try again.");
				}
			}
		</script>
			
		<a id="link0" href="MembershipEncarinoCG.html" class="component napkeeLink">Be a member now!</a> <br><br><br>
		<div id="hline2" class="component horizontal"></div>

		<div id="menu" class="btn-group">
			<a class="btn active" href="index.html">Home</a>
			<a class="btn" href="GalleryEncarinoCG.html">Gallery</a>
			<a class="btn" href="MembershipEncarinoCG.html">Membership</a>
			<a class="btn" href="ContactUsEncarinoCG.html">Contact Us</a>
		</div>
