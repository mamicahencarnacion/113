...
<div id="nap39" class="napkeeComponent napkeeTabbar tabbable tabs-left">
	<ul class="nav nav-tabs">
				...
				<li class="active"><a id="nap39i2" href="#nap39-2" data-toggle="tab">Golf Course</a></li>
...
<span id="nap40" class="napkeeRelativeComponent napkeeSubTitle">Golf Course</span>
	
<span id="nap41" class="napkeeRelativeComponent napkeeSubTitle">Golf Course</span>
	
<span id="nap42" class="napkeeRelativeComponent napkeeSubTitle">Golf Course</span>
	
<span id="nap43" class="napkeeRelativeComponent napkeeSubTitle">Golf Course</span>
