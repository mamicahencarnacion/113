...
<div id="nap39" class="napkeeComponent napkeeTabbar tabbable tabs-left">
	<ul class="nav nav-tabs">
				<li class="active"><a id="nap39i0" href="#nap39-0" data-toggle="tab">Villas</a></li>
...
<span id="nap40" class="napkeeRelativeComponent napkeeSubTitle">Villa</span>
	
<span id="nap41" class="napkeeRelativeComponent napkeeSubTitle">Villa</span>
	
<span id="nap42" class="napkeeRelativeComponent napkeeSubTitle">Villa</span>
	
<span id="nap43" class="napkeeRelativeComponent napkeeSubTitle">Villa</span>
