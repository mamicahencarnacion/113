  ...
  <body>
		...
		<div id="nap39" class="component tabBar tabbable tabs-left">
			<ul class="nav nav-tabs">
				<li class="active"><a id="nap39i0" href="gallery.jsp" data-toggle="tab">Villas</a></li>
		...
		<div id="slide">
			<div id="imageThumbnails">
				<marquee behavior="scroll" direction="down" height="550px"
					...
					<br><br><br>
					<table> <tr> <td><img src="villa1.jpg"></img></td> <br>
					<table> <tr> <td><img src="villa2.jpg"></img></td><br>
					<table> <tr> <td><img src="villa3.jpg"></img></td><br>
					<table> <tr> <td><img src="villa4.jpg"></img></td> <br></tr> </table> 
