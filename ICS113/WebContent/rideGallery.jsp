  ...
  <body>
		...
		<div id="nap39" class="component tabBar tabbable tabs-left">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a id="nap39i4" href="rideGallery.jsp" data-toggle="tab">Riding Clubs</a></li>
				<li><a id="nap39i5" href="wellGallery.jsp" data-toggle="tab">Wellness Center</a></li>
			</ul>
			
			<div id="scrollwindow">
		<span id="nap40" >
			Riding Clubs</span><br>
	...
	<div id="imageThumbnails">
		<marquee behavior="scroll" direction="down" height="550px"
				...
				<br><br><br>
		<table> <tr> <td><img src="ride1.jpg"></img></td> <br>
		<table> <tr> <td><img src="ride2.jpg"></img></td><br>
		<table> <tr> <td><img src="ride3.jpg"></img></td><br>
		<table> <tr> <td><img src="ride4.jpg"></img></td> <br></tr> </table> 
