  ...
  <body>
		...
		<div id="nap39" class="component tabBar tabbable tabs-left">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a id="nap39i5" href="wellGallery.jsp" data-toggle="tab">Wellness Center</a></li>
			</ul>
	...
	<div id="imageThumbnails">
		<marquee behavior="scroll" direction="down" height="550px"
				...
				<br><br><br>
		<table> <tr> <td><img src="well1.jpg"></img></td> <br>
		<table> <tr> <td><img src="well2.jpg"></img></td> <br>
		<table> <tr> <td><img src="well3.jpg"></img></td> <br>
		<table> <tr> <td><img src="well4.jpg"></img></td> <br>
		<table> <tr> <td><img src="well5.jpg"></img></td> <br></tr> </table> 
					
				<br><br><br>
				</marquee>
			</div> </div>

				<div id="nap39-1" class="tab-pane">
				</div>
