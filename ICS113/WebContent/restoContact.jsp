...
<div id="nap39" class="napkeeComponent napkeeTabbar tabbable tabs-left">
	<ul class="nav nav-tabs">
				...
				<li class="active"><a id="nap39i1" href="#nap39-1" data-toggle="tab">Coffee Resto Bar</a></li>
				<li><a id="nap39i2" href="#nap39-2" data-toggle="tab">Golf Course</a></li>
				<li><a id="nap39i3" href="#nap39-3" data-toggle="tab">Lake Side</a></li>
...
<span id="nap40" class="napkeeRelativeComponent napkeeSubTitle">Coffee and Resto</span>
	
<span id="nap41" class="napkeeRelativeComponent napkeeSubTitle">Coffee and Resto</span>
	
<span id="nap42" class="napkeeRelativeComponent napkeeSubTitle">Coffee and Resto</span>
	
<span id="nap43" class="napkeeRelativeComponent napkeeSubTitle">Coffee and Resto</span>
	
	
<!--
<img id="nap44" src="holder.205x129" class="napkeeRelativeComponent napkeeImage" />
<table border="0" id="nap44table" class="napkeeComponent napkeeImageTable" >
	<tr>
		<td align="center" valign="middle">
			<span id="nap44label" class="napkeeImageLabel"></span>
		</td>
	</tr>
</table>

	
<img id="nap45" src="holder.205x129" class="napkeeRelativeComponent napkeeImage" />
<table border="0" id="nap45table" class="napkeeComponent napkeeImageTable" >
	<tr>
		<td align="center" valign="middle">
			<span id="nap45label" class="napkeeImageLabel"></span>
		</td>
	</tr>
</table>

	
<img id="nap46" src="holder.205x129" class="napkeeRelativeComponent napkeeImage" />
<table border="0" id="nap46table" class="napkeeComponent napkeeImageTable" >
	<tr>
		<td align="center" valign="middle">
			<span id="nap46label" class="napkeeImageLabel"></span>
		</td>
	</tr>
</table>

	
<img id="nap47" src="holder.205x129" class="napkeeRelativeComponent napkeeImage" />
<table border="0" id="nap47table" class="napkeeComponent napkeeImageTable" >
	<tr>
		<td align="center" valign="middle">
			<span id="nap47label" class="napkeeImageLabel"></span>
		</td>
	</tr>
</table>
!-->
