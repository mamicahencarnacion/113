...
<style type="text/css">
  ...
  <body>
	...
	<div id="desc" style=" padding: 2%; background-color: #fff; z-index: -1;
		width: 72%;  margin-top:0.5%; margin-bottom: 3%; margin-left: 8%;display: inline-block;padding-left: 10%; ">	
	
		<h1 style="float: left; margin-left: 35%;position: relative; margin-top: 1%; display: in-line bloack;">About Us</h1>
<br>
	<div id="par2" style="text-align: center;position: relative;margin-top: 10%;  padding-bottom: 5%;"cellspacing="0" cellpadding="0">
